...
CATALOG: dict[str, dict[str, str]] = {
    ...
    "settings.ext_intro": {"en": "Clip the page you're on straight into your catalogue — public or private. Chrome for now.", "ru": "Добавляйте открытую страницу прямо в каталог — публично или приватно. Пока Chrome.", "he": "הוספת הדף הנוכחי ישירות לקטלוג — ציבורי או פרטי. בינתיים Chrome."},
