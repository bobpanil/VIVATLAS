...
CATALOG: dict[str, dict[str, str]] = {
    ...
    "mcp.consent.title": {"en": "Connect an app", "ru": "Подключение приложения", "he": "חיבור אפליקציה"},
    "mcp.consent.lede": {"en": "{client} wants to connect to your VIVATLAS and act on your behalf.", "ru": "{client} хочет подключиться к вашему VIVATLAS и действовать от вашего имени.", "he": "{client} רוצה להתחבר ל-VIVATLAS שלך ולפעול בשמך."},
    "mcp.consent.scope": {"en": "It will be able to search and read your cards (private and shared) and to add, edit and file cards.", "ru": "Сможет искать и читать ваши карточки (личные и общие), а также добавлять, редактировать и раскладывать их по папкам.", "he": "הוא יוכל לחפש ולקרוא את הכרטיסים שלך (פרטיים ומשותפים) ולהוסיף, לערוך ולתייק כרטיסים."},
    "mcp.consent.account": {"en": "Signed in as {account}", "ru": "Вы вошли как {account}", "he": "מחובר בתור {account}"},
    "mcp.consent.allow": {"en": "Allow", "ru": "Разрешить", "he": "אישור"},
    "mcp.consent.deny": {"en": "Deny", "ru": "Отклонить", "he": "דחייה"},
    "mcp.consent.expired.title": {"en": "This request expired", "ru": "Запрос устарел", "he": "הבקשה פגה"},
    "mcp.consent.expired.lede": {"en": "Start the connection again from the app.", "ru": "Начните подключение заново из приложения.", "he": "התחל את החיבור מחדש מהאפליקציה."},
    ...
    "settings.tab_extension": {"en": "Browser extension", "ru": "Расширение браузера", "he": "תוסף דפדפן"},
    "settings.tab_chatgpt": {"en": "ChatGPT", "ru": "ChatGPT", "he": "ChatGPT"},
    "settings.tab_security": {"en": "Security", "ru": "Безопасность", "he": "אבטחה"},
    "settings.ext_title": {"en": "Browser clipper", "ru": "Клиппер для браузера", "he": "קליפר לדפדפן"},
    "settings.ext_tip": {"en": "Send any page to VIVATLAS from your browser toolbar.", "ru": "Отправляйте любую страницу в VIVATLAS с панели браузера.", "he": "שליחת כל דף ל-VIVATLAS מסרגל הדפדפן."},
    "settings.ext_intro": {"en": "Clip the page you're on straight into your catalogue — public or private, from your browser toolbar.", "ru": "Добавляйте открытую страницу прямо в каталог — публично или приватно, с панели браузера.", "he": "הוספת הדף הנוכחי ישירות לקטלוג — ציבורי או פרטי, מסרגל הדפדפן."},
    "settings.ext_auto": {"en": "You're signed in automatically — the clipper uses your VIVATLAS session in this browser, so there's no separate extension login. Just stay signed in here.", "ru": "Вход выполняется автоматически — клиппер использует вашу сессию VIVATLAS в этом браузере, отдельный вход в расширение не нужен. Просто оставайтесь в системе.", "he": "הכניסה מתבצעת אוטומטית — הקליפר משתמש בהתחברות שלך ל-VIVATLAS בדפדפן הזה, אין צורך בהתחברות נפרדת בתוסף. רק להישאר מחובר כאן."},
    "settings.ext_chrome": {"en": "Chrome, Edge & other Chromium browsers", "ru": "Chrome, Edge и другие браузеры на Chromium", "he": "Chrome, Edge ודפדפני Chromium אחרים"},
    "settings.ext_firefox": {"en": "Firefox", "ru": "Firefox", "he": "Firefox"},
    "settings.ext_ff_download_btn": {"en": "Download for Firefox", "ru": "Скачать для Firefox", "he": "הורדה עבור Firefox"},
    "settings.ext_ff_step_open": {"en": "Open Firefox's add-on debugging page:", "ru": "Откройте страницу отладки дополнений Firefox:", "he": "פתיחת דף ניפוי התוספות של Firefox:"},
    "settings.ext_ff_step_load": {"en": "Click “Load Temporary Add-on” and choose the manifest.json inside the vivatlas-clipper folder.", "ru": "Нажмите «Загрузить временное дополнение» и выберите manifest.json в папке vivatlas-clipper.", "he": "לחיצה על ‏“Load Temporary Add-on”‏ ובחירת הקובץ manifest.json בתוך התיקייה vivatlas-clipper."},
    "settings.ext_ff_note": {"en": "Firefox drops temporary add-ons when it restarts. To keep it for good, sign the folder into an .xpi at addons.mozilla.org (a free Mozilla account) and install that.", "ru": "Firefox удаляет временные дополнения при перезапуске. Чтобы сохранить навсегда, подпишите папку в .xpi на addons.mozilla.org (бесплатный аккаунт Mozilla) и установите его.", "he": "Firefox מסיר תוספות זמניות בהפעלה מחדש. כדי לשמור לצמיתות, יש לחתום את התיקייה ל-‎.xpi ב-addons.mozilla.org (חשבון Mozilla חינמי) ולהתקין אותו."},
    "settings.ext_step_download": {"en": "Download the clipper and unzip it somewhere you'll keep it.", "ru": "Скачайте клиппер и распакуйте туда, где он останется.", "he": "הורדת הקליפר וחילוץ למקום קבוע."},
    "settings.ext_download_btn": {"en": "Download extension", "ru": "Скачать расширение", "he": "הורדת התוסף"},
    "settings.ext_step_unzip": {"en": "Unzip the downloaded file — you'll get a vivatlas-clipper folder.", "ru": "Распакуйте скачанный файл — появится папка vivatlas-clipper.", "he": "חילוץ הקובץ שהורד — תיווצר תיקייה vivatlas-clipper."},
    "settings.ext_step_open": {"en": "Open the Chrome extensions page:", "ru": "Откройте страницу расширений Chrome:", "he": "פתיחת דף התוספים של Chrome:"},
    "settings.ext_copy": {"en": "Copy", "ru": "Копировать", "he": "העתקה"},
    "settings.ext_copied": {"en": "Copied", "ru": "Скопировано", "he": "הועתק"},
    "settings.ext_step_devmode": {"en": "Turn on “Developer mode” (top-right toggle).", "ru": "Включите «Режим разработчика» (переключатель справа вверху).", "he": "הפעלת ‏“Developer mode”‏ (מתג בפינה הימנית העליונה)."},
    "settings.ext_step_load": {"en": "Click “Load unpacked” and choose the vivatlas-clipper folder.", "ru": "Нажмите «Загрузить распакованное» и выберите папку vivatlas-clipper.", "he": "לחיצה על ‏“Load unpacked”‏ ובחירת התיקייה vivatlas-clipper."},
    "settings.ext_step_signin": {"en": "Open the clipper, and sign in with this server address:", "ru": "Откройте клиппер и войдите, указав адрес сервера:", "he": "פתיחת הקליפר והתחברות עם כתובת השרת:"},
    "settings.ext_note_chrome": {"en": "Works in Chrome, Edge, Brave and other Chromium browsers. Firefox is coming.", "ru": "Работает в Chrome, Edge, Brave и других браузерах на Chromium. Firefox — позже.", "he": "עובד ב-Chrome, Edge, Brave ודפדפני Chromium אחרים. Firefox בהמשך."},
    "settings.ext_unavailable": {"en": "This server wasn't built with the extension bundled. Get it from the project repository instead.", "ru": "Этот сервер собран без расширения. Возьмите его из репозитория проекта.", "he": "השרת הזה נבנה ללא התוסף. אפשר להוריד אותו ממאגר הפרויקט."},
    "settings.mcp_title": {"en": "Connect ChatGPT", "ru": "Подключить ChatGPT", "he": "חיבור ChatGPT"},
    "settings.mcp_tip": {"en": "Let ChatGPT read and curate your library over MCP — including on a schedule.", "ru": "Позвольте ChatGPT читать и вести ваш каталог через MCP — в том числе по расписанию.", "he": "אפשר ל-ChatGPT לקרוא ולנהל את הספרייה שלך דרך MCP — גם לפי לוח זמנים."},
    "settings.mcp_intro": {"en": "Connect ChatGPT as you: it sees your private and shared cards and can add, edit and file them.", "ru": "Подключите ChatGPT от своего имени: он видит ваши личные и общие карточки и может добавлять, редактировать и раскладывать их.", "he": "חיבור ChatGPT בשמך: הוא רואה את הכרטיסים הפרטיים והמשותפים שלך ויכול להוסיף, לערוך ולתייק אותם."},
    "settings.mcp_step_url": {"en": "Copy your connector address:", "ru": "Скопируйте адрес коннектора:", "he": "העתקת כתובת המחבר:"},
    "settings.mcp_step_devmode": {"en": "In ChatGPT, turn on Developer mode (Settings → Connectors → Advanced).", "ru": "В ChatGPT включите режим разработчика (Настройки → Коннекторы → Дополнительно).", "he": "ב-ChatGPT הפעל מצב מפתח (הגדרות → מחברים → מתקדם)."},
    "settings.mcp_step_add": {"en": "Add a custom connector, paste the address, and approve the VIVATLAS sign-in it opens.", "ru": "Добавьте свой коннектор, вставьте адрес и подтвердите вход в VIVATLAS.", "he": "הוספת מחבר מותאם, הדבקת הכתובת ואישור ההתחברות ל-VIVATLAS שנפתחת."},
    "settings.mcp_step_use": {"en": "Ask it to scan your library and suggest additions/edits — or set a Scheduled Task to do it daily.", "ru": "Попросите просканировать каталог и предложить дополнения/правки — или создайте запланированную задачу.", "he": "בקש ממנו לסרוק את הספרייה ולהציע הוספות/עריכות — או הגדר משימה מתוזמנת יומית."},
    "settings.mcp_task_hint": {"en": "Example task: “Each morning, scan my VIVATLAS library and suggest tools to add and summaries to fix.”", "ru": "Пример задачи: «Каждое утро сканируй мой каталог VIVATLAS и предлагай, что добавить и какие описания поправить».", "he": "משימה לדוגמה: ‏“כל בוקר סרוק את ספריית VIVATLAS שלי והצע כלים להוספה ותיאורים לתיקון.”"},
    "settings.mcp_authorized": {"en": "Authorized apps", "ru": "Подключённые приложения", "he": "אפליקציות מאושרות"},
    "settings.mcp_revoke": {"en": "Revoke", "ru": "Отозвать", "he": "ביטול"},
    "settings.mcp_none": {"en": "No apps connected yet.", "ru": "Пока ничего не подключено.", "he": "אין אפליקציות מחוברות עדיין."},
    "settings.mcp_unavailable": {"en": "Set PUBLIC_URL (your public https address) in the server config to enable connecting ChatGPT.", "ru": "Укажите PUBLIC_URL (публичный https-адрес) в настройках сервера, чтобы подключать ChatGPT.", "he": "הגדר PUBLIC_URL (כתובת ה-https הציבורית) בהגדרות השרת כדי לאפשר חיבור ChatGPT."},
